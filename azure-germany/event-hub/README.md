...
This directory contains Bicep variable files for the **EventHub** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/event-hub/event-hub:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/event-hub/region/event-hub-germany-central:latest`
