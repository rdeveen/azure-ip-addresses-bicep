...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/hd-insight/hd-insight:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/hd-insight/region/hd-insight-germany-central:latest`
