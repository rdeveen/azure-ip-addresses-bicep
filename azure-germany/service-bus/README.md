...
This directory contains Bicep variable files for the **ServiceBus** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/service-bus/service-bus:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/service-bus/region/service-bus-germany-central:latest`
