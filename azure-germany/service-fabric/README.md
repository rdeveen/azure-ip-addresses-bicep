...
This directory contains Bicep variable files for the **ServiceFabric** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/service-fabric/service-fabric:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/service-fabric/region/service-fabric-germany-central:latest`
