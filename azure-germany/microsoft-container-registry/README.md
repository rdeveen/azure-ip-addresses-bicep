...
This directory contains Bicep variable files for the **MicrosoftContainerRegistry** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/microsoft-container-registry/microsoft-container-registry:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/microsoft-container-registry/region/microsoft-container-registry-germany-central:latest`
