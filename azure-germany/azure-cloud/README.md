...
This directory contains Bicep variable files for the **AzureCloud** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-cloud/azure-cloud:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-cloud/region/azure-cloud-germanycentral:latest`
