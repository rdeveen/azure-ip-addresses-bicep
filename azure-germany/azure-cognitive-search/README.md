...
This directory contains Bicep variable files for the **AzureCognitiveSearch** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-cognitive-search/azure-cognitive-search:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-cognitive-search/region/azure-cognitive-search-germany-central:latest`
