...
This directory contains Bicep variable files for the **AppConfiguration** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/app-configuration/app-configuration:latest`
