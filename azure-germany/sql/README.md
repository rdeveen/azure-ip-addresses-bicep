...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/sql/sql:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/sql/region/sql-germany-central:latest`
