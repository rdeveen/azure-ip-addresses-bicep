...
This directory contains Bicep variable files for the **AzureBackup** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-backup/azure-backup:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-backup/region/azure-backup-germany-central:latest`
