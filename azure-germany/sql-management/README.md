...
This directory contains Bicep variable files for the **SqlManagement** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/sql-management/sql-management:latest`
