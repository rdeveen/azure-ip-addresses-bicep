...
This directory contains Bicep variable files for the **AzureResourceManager** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-resource-manager/azure-resource-manager:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-resource-manager/region/azure-resource-manager-germany-central:latest`
