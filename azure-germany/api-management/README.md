...
This directory contains Bicep variable files for the **ApiManagement** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/api-management/api-management:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/api-management/region/api-management-germany-central:latest`
