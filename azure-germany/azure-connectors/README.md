...
This directory contains Bicep variable files for the **AzureConnectors** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-connectors/azure-connectors:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-connectors/region/azure-connectors-germany-central:latest`
