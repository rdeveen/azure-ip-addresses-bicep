...
This directory contains Bicep variable files for the **AzureKeyVault** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-key-vault/azure-key-vault:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-key-vault/region/azure-key-vault-germany-central:latest`
