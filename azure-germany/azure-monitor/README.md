...
This directory contains Bicep variable files for the **AzureMonitor** service tag in the **Azure Germany Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-monitor/azure-monitor:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-germany/azure-monitor/region/azure-monitor-germany-central:latest`
