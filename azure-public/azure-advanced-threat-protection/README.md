...
This directory contains Bicep variable files for the **AzureAdvancedThreatProtection** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-advanced-threat-protection/azure-advanced-threat-protection:latest`
