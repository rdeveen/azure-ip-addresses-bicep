...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-event-grid/azure-event-grid:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-event-grid/region/azure-event-grid-australia-central:latest`
