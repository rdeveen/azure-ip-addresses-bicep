...
This directory contains Bicep variable files for the **ActionGroup** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/action-group/action-group:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/action-group/region/action-group-australia-central:latest`
