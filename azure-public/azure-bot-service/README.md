...
This directory contains Bicep variable files for the **AzureBotService** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-bot-service/azure-bot-service:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-bot-service/region/azure-bot-service-australia-central:latest`
