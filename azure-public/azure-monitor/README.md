...
This directory contains Bicep variable files for the **AzureMonitor** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-monitor/azure-monitor:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-monitor/region/azure-monitor-australia-central:latest`
