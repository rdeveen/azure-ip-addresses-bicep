...
This directory contains Bicep variable files for the **MicrosoftPurviewPolicyDistribution** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/microsoft-purview-policy-distribution/microsoft-purview-policy-distribution:latest`
