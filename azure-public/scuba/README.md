...
This directory contains Bicep variable files for the **Scuba** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/scuba/scuba:latest`
