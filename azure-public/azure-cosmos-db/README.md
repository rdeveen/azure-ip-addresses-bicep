...
This directory contains Bicep variable files for the **AzureCosmosDB** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-cosmos-db/azure-cosmos-db:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-cosmos-db/region/azure-cosmos-db-australia-central:latest`
