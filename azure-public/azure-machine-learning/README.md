...
This directory contains Bicep variable files for the **AzureMachineLearning** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-machine-learning/azure-machine-learning:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-machine-learning/region/azure-machine-learning-australia-central:latest`
