...
This directory contains Bicep variable files for the **AzureSpringCloud** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-spring-cloud/azure-spring-cloud:latest`
