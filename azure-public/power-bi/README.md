...
This directory contains Bicep variable files for the **PowerBI** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/power-bi/power-bi:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/power-bi/region/power-bi-australia-central:latest`
