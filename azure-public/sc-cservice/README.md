...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/sc-cservice/sc-cservice:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/sc-cservice/region/sc-cservice-australia-central:latest`
