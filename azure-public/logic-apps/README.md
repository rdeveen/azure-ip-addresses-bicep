...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/logic-apps/logic-apps:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/logic-apps/region/logic-apps-australia-central:latest`
