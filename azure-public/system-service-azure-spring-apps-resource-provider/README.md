...
This directory contains Bicep variable files for the **SystemServiceAzureSpringAppsResourceProvider** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/system-service-azure-spring-apps-resource-provider/system-service-azure-spring-apps-resource-provider:latest`
