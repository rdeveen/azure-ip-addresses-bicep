...
This directory contains Bicep variable files for the **AppConfiguration** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/app-configuration/app-configuration:latest`
