...
This directory contains Bicep variable files for the **MicrosoftAzureFluidRelay** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/microsoft-azure-fluid-relay/microsoft-azure-fluid-relay:latest`
