...
This directory contains Bicep variable files for the **AzureAttestation** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-attestation/azure-attestation:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-attestation/region/azure-attestation-australia-central:latest`
