...
This directory contains Bicep variable files for the **EventHub** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/event-hub/event-hub:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/event-hub/region/event-hub-australia-central:latest`
