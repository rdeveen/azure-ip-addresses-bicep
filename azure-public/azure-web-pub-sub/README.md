...
This directory contains Bicep variable files for the **AzureWebPubSub** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-web-pub-sub/azure-web-pub-sub:latest`
