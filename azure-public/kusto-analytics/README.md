...
This directory contains Bicep variable files for the **KustoAnalytics** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/kusto-analytics/kusto-analytics:latest`
