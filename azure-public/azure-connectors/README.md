...
This directory contains Bicep variable files for the **AzureConnectors** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-connectors/azure-connectors:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-connectors/region/azure-connectors-australia-central:latest`
