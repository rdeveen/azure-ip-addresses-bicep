...
This directory contains Bicep variable files for the **AzureDatabricks** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-databricks/azure-databricks:latest`
