...
This directory contains Bicep variable files for the **HDInsight** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/hd-insight/hd-insight:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/hd-insight/region/hd-insight-australia-central:latest`
