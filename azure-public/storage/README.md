...
This directory contains Bicep variable files for the **Storage** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/storage/storage:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/storage/region/storage-australia-central:latest`
