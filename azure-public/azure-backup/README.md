...
This directory contains Bicep variable files for the **AzureBackup** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-backup/azure-backup:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/azure-backup/region/azure-backup-australia-central:latest`
