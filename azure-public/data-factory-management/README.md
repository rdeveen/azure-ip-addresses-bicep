...
This directory contains Bicep variable files for the **DataFactoryManagement** service tag in the **Azure Public Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-public/data-factory-management/data-factory-management:latest`
