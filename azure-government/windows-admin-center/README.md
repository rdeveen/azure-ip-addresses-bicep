...
This directory contains Bicep variable files for the **WindowsAdminCenter** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/windows-admin-center/windows-admin-center:latest`
