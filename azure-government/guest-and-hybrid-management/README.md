...
This directory contains Bicep variable files for the **GuestAndHybridManagement** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/guest-and-hybrid-management/guest-and-hybrid-management:latest`
