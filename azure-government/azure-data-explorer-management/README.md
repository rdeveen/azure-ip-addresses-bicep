...
This directory contains Bicep variable files for the **AzureDataExplorerManagement** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-data-explorer-management/azure-data-explorer-management:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-data-explorer-management/region/azure-data-explorer-management-us-do-d-central:latest`
