...
This directory contains Bicep variable files for the **ApiManagement** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/api-management/api-management:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/api-management/region/api-management-us-do-d-central:latest`
