...
This directory contains Bicep variable files for the **AzureSiteRecovery** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-site-recovery/azure-site-recovery:latest`
