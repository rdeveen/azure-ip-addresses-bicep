...
This directory contains Bicep variable files for the **AzureEventGrid** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-event-grid/azure-event-grid:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-event-grid/region/azure-event-grid-us-do-d-central:latest`
