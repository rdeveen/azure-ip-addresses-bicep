...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/power-platform-infra/power-platform-infra:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/power-platform-infra/region/power-platform-infra-us-do-d-central:latest`
