...
This directory contains Bicep variable files for the **LogicAppsManagement** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/logic-apps-management/logic-apps-management:latest`
