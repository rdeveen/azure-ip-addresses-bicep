...
This directory contains Bicep variable files for the **MicrosoftPurviewPolicyDistribution** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/microsoft-purview-policy-distribution/microsoft-purview-policy-distribution:latest`
