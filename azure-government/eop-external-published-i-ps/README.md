...
This directory contains Bicep variable files for the **EOPExternalPublishedIPs** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/eop-external-published-i-ps/eop-external-published-i-ps:latest`
