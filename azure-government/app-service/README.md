...
This directory contains Bicep variable files for the **AppService** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/app-service/app-service:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/app-service/region/app-service-us-do-d-central:latest`
