...
This directory contains Bicep variable files for the **AzureActiveDirectoryDomainServices** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-active-directory-domain-services/azure-active-directory-domain-services:latest`
