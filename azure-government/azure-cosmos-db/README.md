...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-cosmos-db/azure-cosmos-db:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-cosmos-db/region/azure-cosmos-db-us-do-d-central:latest`
