...
This directory contains Bicep variable files for the **AzureSentinel** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-sentinel/azure-sentinel:latest`
