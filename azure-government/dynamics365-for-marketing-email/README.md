...
This directory contains Bicep variable files for the **Dynamics365ForMarketingEmail** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/dynamics365-for-marketing-email/dynamics365-for-marketing-email:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/dynamics365-for-marketing-email/region/dynamics365-for-marketing-email-us-gov-texas:latest`
