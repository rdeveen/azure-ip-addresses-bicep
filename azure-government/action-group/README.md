...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/action-group/action-group:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/action-group/region/action-group-us-do-d-central:latest`
