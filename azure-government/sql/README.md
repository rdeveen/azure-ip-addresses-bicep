...
This directory contains Bicep variable files for the **Sql** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/sql/sql:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/sql/region/sql-us-do-d-central:latest`
