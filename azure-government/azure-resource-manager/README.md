...
This directory contains Bicep variable files for the **AzureResourceManager** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-resource-manager/azure-resource-manager:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-resource-manager/region/azure-resource-manager-us-do-d-central:latest`
