...
This directory contains Bicep variable files for the **AzureMachineLearningInference** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-machine-learning-inference/azure-machine-learning-inference:latest`
