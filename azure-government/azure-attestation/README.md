...
This directory contains Bicep variable files for the **AzureAttestation** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-attestation/azure-attestation:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-attestation/region/azure-attestation-us-do-d-central:latest`
