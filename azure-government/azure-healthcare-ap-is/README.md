...
This directory contains Bicep variable files for the **AzureHealthcareAPIs** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-healthcare-ap-is/azure-healthcare-ap-is:latest`
