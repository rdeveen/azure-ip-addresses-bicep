...
This directory contains Bicep variable files for the **AzureActiveDirectory** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-active-directory/azure-active-directory:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-active-directory/region/azure-active-directory-service-endpoint:latest`
