...
This directory contains Bicep variable files for the **AzureKeyVault** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-key-vault/azure-key-vault:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-key-vault/region/azure-key-vault-us-do-d-central:latest`
