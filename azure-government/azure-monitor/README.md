...
This directory contains Bicep variable files for the **AzureMonitor** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-monitor/azure-monitor:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/azure-monitor/region/azure-monitor-core:latest`
