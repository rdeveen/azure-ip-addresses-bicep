...
This directory contains Bicep variable files for the **MicrosoftAzureFluidRelay** service tag in the **Azure US Government Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-government/microsoft-azure-fluid-relay/microsoft-azure-fluid-relay:latest`
