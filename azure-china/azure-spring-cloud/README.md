...
This directory contains Bicep variable files for the **AzureSpringCloud** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-spring-cloud/azure-spring-cloud:latest`
