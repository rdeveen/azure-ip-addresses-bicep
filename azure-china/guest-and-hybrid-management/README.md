...
This directory contains Bicep variable files for the **GuestAndHybridManagement** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/guest-and-hybrid-management/guest-and-hybrid-management:latest`
