...
This directory contains Bicep variable files for the **Dynamics365ForMarketingEmail** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/dynamics365-for-marketing-email/dynamics365-for-marketing-email:latest`
