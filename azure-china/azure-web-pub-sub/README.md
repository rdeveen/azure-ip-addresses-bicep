...
This directory contains Bicep variable files for the **AzureWebPubSub** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-web-pub-sub/azure-web-pub-sub:latest`
