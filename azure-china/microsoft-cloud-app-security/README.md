...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/microsoft-cloud-app-security/microsoft-cloud-app-security:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/microsoft-cloud-app-security/region/microsoft-cloud-app-security-china-east:latest`
