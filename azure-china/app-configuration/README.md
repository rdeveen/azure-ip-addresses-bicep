...
This directory contains Bicep variable files for the **AppConfiguration** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/app-configuration/app-configuration:latest`
