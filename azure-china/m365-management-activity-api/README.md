...
This directory contains Bicep variable files for the **M365ManagementActivityApi** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/m365-management-activity-api/m365-management-activity-api:latest`
