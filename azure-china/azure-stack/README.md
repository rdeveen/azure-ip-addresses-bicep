...
This directory contains Bicep variable files for the **AzureStack** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-stack/azure-stack:latest`
