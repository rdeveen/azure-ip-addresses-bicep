...
This directory contains Bicep variable files for the **AzureActiveDirectoryDomainServices** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-active-directory-domain-services/azure-active-directory-domain-services:latest`
