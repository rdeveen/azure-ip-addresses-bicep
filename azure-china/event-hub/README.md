...
This directory contains Bicep variable files for the **EventHub** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/event-hub/event-hub:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/event-hub/region/event-hub-china-east:latest`
