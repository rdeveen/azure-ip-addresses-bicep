...
This directory contains Bicep variable files for the **GatewayManager** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/gateway-manager/gateway-manager:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/gateway-manager/region/gateway-manager-china-east:latest`
