...
This directory contains Bicep variable files for the **ApplicationInsightsAvailability** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/application-insights-availability/application-insights-availability:latest`
