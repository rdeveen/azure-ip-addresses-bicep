...
This directory contains Bicep variable files for the **AzurePortal** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-portal/azure-portal:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-portal/region/azure-portal-china-east:latest`
