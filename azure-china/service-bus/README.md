...
This directory contains Bicep variable files for the **ServiceBus** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/service-bus/service-bus:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/service-bus/region/service-bus-china-east:latest`
