...
This directory contains Bicep variable files for the **AzureHealthcareAPIs** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-healthcare-ap-is/azure-healthcare-ap-is:latest`
