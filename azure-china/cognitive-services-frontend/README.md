...
This directory contains Bicep variable files for the **CognitiveServicesFrontend** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/cognitive-services-frontend/cognitive-services-frontend:latest`
