...
This directory contains Bicep variable files for the **AzureConnectors** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-connectors/azure-connectors:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-connectors/region/azure-connectors-china-east:latest`
