...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/power-platform-plex/power-platform-plex:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/power-platform-plex/region/power-platform-plex-china-east2:latest`
