...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/logic-apps/logic-apps:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/logic-apps/region/logic-apps-china-east:latest`
