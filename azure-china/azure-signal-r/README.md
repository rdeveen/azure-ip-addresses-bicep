...
This directory contains Bicep variable files for the **AzureSignalR** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-signal-r/azure-signal-r:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-signal-r/region/azure-signal-r-china-east2:latest`
