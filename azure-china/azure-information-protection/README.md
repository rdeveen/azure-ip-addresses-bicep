...
This directory contains Bicep variable files for the **AzureInformationProtection** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-information-protection/azure-information-protection:latest`
