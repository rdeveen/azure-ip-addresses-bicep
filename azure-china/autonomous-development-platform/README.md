...
This directory contains Bicep variable files for the **AutonomousDevelopmentPlatform** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/autonomous-development-platform/autonomous-development-platform:latest`
