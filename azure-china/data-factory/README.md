...
This directory contains Bicep variable files for the **DataFactory** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/data-factory/data-factory:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/data-factory/region/data-factory-china-east:latest`
