...
This directory contains Bicep variable files for the **AzureTrafficManager** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-traffic-manager/azure-traffic-manager:latest`
