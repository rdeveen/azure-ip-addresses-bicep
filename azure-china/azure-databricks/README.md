...
This directory contains Bicep variable files for the **AzureDatabricks** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-databricks/azure-databricks:latest`
