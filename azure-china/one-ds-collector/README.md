...
This directory contains Bicep variable files for the **OneDsCollector** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/one-ds-collector/one-ds-collector:latest`
