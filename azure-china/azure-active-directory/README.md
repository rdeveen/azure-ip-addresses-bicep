...
This directory contains Bicep variable files for the **AzureActiveDirectory** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-active-directory/azure-active-directory:latest`

Example regional module:
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/azure-active-directory/region/azure-active-directory-service-endpoint:latest`
