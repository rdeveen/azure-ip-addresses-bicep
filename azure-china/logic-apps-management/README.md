...
This directory contains Bicep variable files for the **LogicAppsManagement** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/logic-apps-management/logic-apps-management:latest`
