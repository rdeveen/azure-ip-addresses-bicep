...
This directory contains Bicep variable files for the **CognitiveServicesManagement** service tag in the **Azure China Cloud**.
...
`br:ghcr.io/rdeveen/azure-ip-addresses-bicep/azure-china/cognitive-services-management/cognitive-services-management:latest`
